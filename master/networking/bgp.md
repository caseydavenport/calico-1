...
-  by the
   [node's]({{site.url}}/{{page.version}}/reference/calicoctl/resources/node)
   `spec.bgp.asNumber`, if that is defined;
-  otherwise by the `spec.asNumber` of the default [BGPConfiguration
   resource]({{site.url}}/{{page.version}}/reference/calicoctl/resources/bgpconfig),
   if that is defined;
...
resource]({{site.url}}/{{page.version}}/reference/calicoctl/resources/bgppeer) provides
...
selector]({{site.url}}/{{page.version}}/reference/calicoctl/resources/networkpolicy#selector).
...
model]({{site.url}}/{{page.version}}/networking/design/l3-interconnect-fabric#the-as-per-rack-model)
...
**Prerequisite**: `calicoctl` [installed]({{site.url}}/{{page.version}}/getting-started/calicoctl/install) and [configured]({{site.url}}/{{page.version}}/getting-started/calicoctl/configure/).
...
1. If the resource _does_ exist, skip to step 3. Otherwise, use the following
   ...
   Refer to [BGP Configuration Resource]({{site.url}}/{{page.version}}/reference/calicoctl/resources/bgpconfig) for details about these settings.
...
1.  Modify the [Node
    resource]({{site.url}}/{{page.version}}/reference/calicoctl/resources/node) for each
    of those nodes, to:
...
1.  Configure a [BGPPeer
    resource]({{site.url}}/{{page.version}}/reference/calicoctl/resources/bgppeer) to tell
