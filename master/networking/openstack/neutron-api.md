...
of what Neutron generally allows (see [IP addressing and connectivity]({{site.url}}/{{page.version}}/networking/openstack/connectivity)) and because it's a purely layer 3 model (see [The {{site.prodname}} data path]({{site.url}}/{{page.version}}/reference/architecture/data-path), not all Neutron API calls will have the same effect as they would with other backends.
...
found in [Set up OpenStack]({{site.url}}/{{page.version}}/networking/openstack/connectivity#opens-external-conn-setup).
...
[IP addressing and connectivity]({{site.url}}/{{page.version}}/networking/openstack/connectivity) to understand why Neutron provider networks are not
needed.
...
be found in [Set up OpenStack]({{site.url}}/{{page.version}}/networking/openstack/connectivity#opens-external-conn-setup).
...
for almost all Neutron objects to zero. For more information, see [Set up OpenStack]({{site.url}}/{{page.version}}/networking/openstack/connectivity#opens-external-conn-setup).
