...
only applies to [network policies]({{site.url}}/{{page.version}}/reference/calicoctl/resources/networkpolicy)
in that namespace. Two resources are in the same namespace if the `namespace`
value is set the same on both. (See [GlobalNetworkSet]({{site.url}}/{{page.version}}/reference/calicoctl/resources/globalnetworkset) for non-namespaced network sets.)
...
[network policy]({{site.url}}/{{page.version}}/reference/calicoctl/resources/networkpolicy) rule, it includes
